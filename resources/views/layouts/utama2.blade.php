...
<a class="navbar-brand js-scroll-trigger" href="/"><img src="{{ asset('utama/img/gkjLogo.png') }}"width="50px" height="auto"> GKJ Samironobaru</a>
  ...
  <ol class="breadcrumb" style="padding-top:10%;padding-bottom:30px">
